<template>
  <header class="main ">
    ...
    <div class="top-slide">
      <!-- top slider  -->
      <div class="top-slider-title" :style="{ transform: `translateY(${translate}px)`}">
      <section class="flex top items-center justify-between mx-auto">
        <div class="top-left">
          <h1 class="event-title text-[58px] w-[100%] leading-tight font-bold">Energy Fest 2023</h1>
          <p class="text-[18px] w-[80%]">Who says it has to be 5? We do four days of full productivity and finish expected deliverables with no adjustments, the</p>
      ...
      <section class="flex top items-center justify-between mx-auto">
        <div class="top-left">
          <h1 class="event-title text-[58px] w-[100%] leading-tight font-bold">Apple Fest 2024</h1>
          <p class="text-[18px] w-[80%]">Who says it has to be 5? We do four days of full productivity and finish expected deliverables with no adjustments, the</p>
          <div class="links flex gap-5 items-center">
            <primary-button label="Buy tickets"></primary-button>
      ...
      <section class="flex top items-center justify-between mx-auto">
        <div class="top-left">
          <h1 class="event-title text-[58px] w-[100%] leading-tight font-bold">Surulere games Fest 2025</h1>
          <p class="text-[18px] w-[80%]">Who says it has to be 5? We do four days of full productivity and finish expected deliverables with no adjustments, the</p>
          <div class="links flex gap-5 items-center">
            <primary-button label="Buy tickets"></primary-button>
            <h3 class=" text-3xl">N20,000</h3>
    ...
    <section class="bottom">
        <swiper class="images" >
          <div  v-for="image in images" :key="image.id" :class="{ last: image.last, back: !image.active && !image.last, front: image.active, absolute: true}" class="image pointer-events-none" >
